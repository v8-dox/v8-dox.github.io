...
Resume execution capability in the given isolate, whose execution was previously forcefully terminated using \hyperlink{classv8_1_1_v8_a81a47f6709c7d376a448d6315398aeb8}{Terminate\+Execution()}.

When execution is forcefully terminated using \hyperlink{classv8_1_1_v8_a81a47f6709c7d376a448d6315398aeb8}{Terminate\+Execution()}, the isolate can not resume execution until all Java\+Script frames have propagated the uncatchable exception which is generated. This method allows the program embedding the engine to handle the termination event and resume execution capability, even if Java\+Script frames remain on the stack.
...
A helper class \hyperlink{classv8_1_1_startup_data_decompressor}{Startup\+Data\+Decompressor} is provided. It implements the protocol of the interaction described above, and can be used in most cases instead of calling these A\+P\+I functions directly. \hypertarget{classv8_1_1_v8_afcecc0e9e8b5fa17a06a93f7b5a7538d}{}\index{v8\+::\+V8@{v8\+::\+V8}!Get\+Version@{Get\+Version}}
...
Allows the host application to provide a callback that allows \hyperlink{namespacev8}{v8} to cooperate with a profiler that rewrites return addresses on stack. \hypertarget{classv8_1_1_v8_a81a47f6709c7d376a448d6315398aeb8}{}\index{v8\+::\+V8@{v8\+::\+V8}!Terminate\+Execution@{Terminate\+Execution}}
