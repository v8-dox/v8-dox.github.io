...
Callback function for the host to ensure debug messages are processed. \hypertarget{classv8_1_1_debug_ab53894746a21222796062f0e81ea28d8}{}\index{v8\+::\+Debug@{v8\+::\+Debug}!Event\+Callback@{Event\+Callback}}
...
\hline
\end{DoxyParams}
A Event\+Callback2 does not take possession of the event data, and must not rely on the data persisting after the handler returns. \hypertarget{classv8_1_1_debug_a526826b857bd3e3efa184e12bcebc694}{}\index{v8\+::\+Debug@{v8\+::\+Debug}!Message\+Handler@{Message\+Handler}}
...
Debugger is running in its own context which is entered while debugger messages are being dispatched. This is an explicit getter for this debugger context. Note that the content of the debugger context is subject to change. \hypertarget{classv8_1_1_debug_a888e06766caee0380c6aa010b00e1a54}{}\index{v8\+::\+Debug@{v8\+::\+Debug}!Process\+Debug\+Messages@{Process\+Debug\+Messages}}
...
\char`\"{}\+Evaluate\char`\"{} debug command behavior currently is not specified in scope of this method. \hypertarget{classv8_1_1_debug_ab635f979d369bed13187e2594d825517}{}\index{v8\+::\+Debug@{v8\+::\+Debug}!Set\+Live\+Edit\+Enabled@{Set\+Live\+Edit\+Enabled}}
...
\item[{bool}]{enable}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_debug_ab635f979d369bed13187e2594d825517}
Enable/disable Live\+Edit functionality for the given \hyperlink{classv8_1_1_isolate}{Isolate} (default \hyperlink{classv8_1_1_isolate}{Isolate} if not provided). \hyperlink{classv8_1_1_v8}{V8} will abort if Live\+Edit is unexpectedly used. Live\+Edit is enabled by default. \hypertarget{classv8_1_1_debug_a54d0cb1ba8b081980153f65c86a90390}{}\index{v8\+::\+Debug@{v8\+::\+Debug}!V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+\_\+\+S\+O\+O\+N@{V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+\_\+\+S\+O\+O\+N}}
...
\item[{{\bf Local}$<$ {\bf Value} $>$ }]{Callv8\+::\+Handle$<$ v8\+::\+Function $>$ fun, Handle$<$ Value $>$ data=\+Handle$<$ Value $>$()}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_debug_a54d0cb1ba8b081980153f65c86a90390}
...
\}
\end{DoxyCode}
 \hypertarget{classv8_1_1_debug_a793bef4362b7d5d2b1a2b4c8a628697b}{}\index{v8\+::\+Debug@{v8\+::\+Debug}!V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+\_\+\+S\+O\+O\+N@{V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+\_\+\+S\+O\+O\+N}}
\index{V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+\_\+\+S\+O\+O\+N@{V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+\_\+\+S\+O\+O\+N}!v8\+::\+Debug@{v8\+::\+Debug}}
\subsubsection[{V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+\_\+\+S\+O\+O\+N}]{\setlength{\rightskip}{0pt plus 5cm}static v8\+::\+Debug\+::\+V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+\_\+\+S\+O\+O\+N (
\begin{DoxyParamCaption}
\item[{\char`\"{}Use maybe version\char`\"{}}]{, }
\item[{{\bf Local}$<$ {\bf Value} $>$ }]{Get\+Mirrorv8\+::\+Handle$<$ v8\+::\+Value $>$ obj}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_debug_a793bef4362b7d5d2b1a2b4c8a628697b}
