...
\item 
V8\+\_\+\+I\+N\+L\+I\+N\+E bool \hyperlink{classv8_1_1_local_ae89b4a4ded13da43d30d9f1a1add8844}{Is\+Empty} () const 
\item 
V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_local_a6fcf63af6bdd697ddd7c3acd16c69899}{Clear} ()
\item 
\hypertarget{classv8_1_1_local_a46326965caccd4c0e7d0f69d129f356a}{}V8\+\_\+\+I\+N\+L\+I\+N\+E T $\ast$ {\bfseries operator-\/$>$} () const \label{classv8_1_1_local_a46326965caccd4c0e7d0f69d129f356a}

\item 
\hypertarget{classv8_1_1_local_a2aee613b47fb87149c1a9c5af2682826}{}V8\+\_\+\+I\+N\+L\+I\+N\+E T $\ast$ {\bfseries operator$\ast$} () const \label{classv8_1_1_local_a2aee613b47fb87149c1a9c5af2682826}

\item 
{\footnotesize template$<$class S $>$ }\\V8\+\_\+\+I\+N\+L\+I\+N\+E bool \hyperlink{classv8_1_1_local_a85570b6ff0a3328627d1b7bc11513a5b}{operator==} (const \hyperlink{classv8_1_1_local}{Local}$<$ S $>$ \&that) const 
\item 
\hypertarget{classv8_1_1_local_af3b99ed885d28df2c7c8d0badce5984b}{}{\footnotesize template$<$class S $>$ }\\V8\+\_\+\+I\+N\+L\+I\+N\+E bool {\bfseries operator==} (const \hyperlink{classv8_1_1_persistent_base}{Persistent\+Base}$<$ S $>$ \&that) const \label{classv8_1_1_local_af3b99ed885d28df2c7c8d0badce5984b}

\item 
{\footnotesize template$<$class S $>$ }\\V8\+\_\+\+I\+N\+L\+I\+N\+E bool \hyperlink{classv8_1_1_local_a5739e619db6d06074d02d99a1b1c79d7}{operator!=} (const \hyperlink{classv8_1_1_local}{Local}$<$ S $>$ \&that) const 
\item 
\hypertarget{classv8_1_1_local_af80626441fe9ff1b746763b0e47b697d}{}{\footnotesize template$<$class S $>$ }\\V8\+\_\+\+I\+N\+L\+I\+N\+E bool {\bfseries operator!=} (const \hyperlink{classv8_1_1_persistent}{Persistent}$<$ S $>$ \&that) const \label{classv8_1_1_local_af80626441fe9ff1b746763b0e47b697d}
...
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E \hyperlink{classv8_1_1_local}{Local}$<$ T $>$ \hyperlink{classv8_1_1_local_a1b3c386fb10d9e8f67aecec9174de1fa}{New} (\hyperlink{classv8_1_1_isolate}{Isolate} $\ast$isolate, \hyperlink{classv8_1_1_local}{Local}$<$ T $>$ that)
\item 
\hypertarget{classv8_1_1_local_a9ffe326224dc9b8a0b47d61b1f877741}{}static V8\+\_\+\+I\+N\+L\+I\+N\+E \hyperlink{classv8_1_1_local}{Local}$<$ T $>$ {\bfseries New} (\hyperlink{classv8_1_1_isolate}{Isolate} $\ast$isolate, const \hyperlink{classv8_1_1_persistent_base}{Persistent\+Base}$<$ T $>$ \&that)\label{classv8_1_1_local_a9ffe326224dc9b8a0b47d61b1f877741}
...
\item 
\hypertarget{classv8_1_1_local_a8c1dab86fc095fca89075da411a82209}{}{\footnotesize template$<$class F $>$ }\\class {\bfseries Maybe\+Local}\label{classv8_1_1_local_a8c1dab86fc095fca89075da411a82209}
...
\hypertarget{classv8_1_1_local_a6fcf63af6bdd697ddd7c3acd16c69899}{}\index{v8\+::\+Local@{v8\+::\+Local}!Clear@{Clear}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_local_a6fcf63af6bdd697ddd7c3acd16c69899}
Sets the handle to be empty. \hyperlink{classv8_1_1_local_ae89b4a4ded13da43d30d9f1a1add8844}{Is\+Empty()} will then return true. \hypertarget{classv8_1_1_local_ae89b4a4ded13da43d30d9f1a1add8844}{}\index{v8\+::\+Local@{v8\+::\+Local}!Is\+Empty@{Is\+Empty}}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_local_ae89b4a4ded13da43d30d9f1a1add8844}
Returns true if the handle is empty. \hypertarget{classv8_1_1_local_a1b3c386fb10d9e8f67aecec9174de1fa}{}\index{v8\+::\+Local@{v8\+::\+Local}!New@{New}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_local_a1b3c386fb10d9e8f67aecec9174de1fa}
Create a local handle for the content of another handle. The referee is kept alive by the local handle even when the original handle is destroyed/disposed. \hypertarget{classv8_1_1_local_a5739e619db6d06074d02d99a1b1c79d7}{}\index{v8\+::\+Local@{v8\+::\+Local}!operator"!=@{operator"!=}}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_local_a5739e619db6d06074d02d99a1b1c79d7}
Checks whether two handles are different. Returns true if only one of the handles is empty, or if the objects to which they refer are different. The handles\textquotesingle{} references are not checked. \hypertarget{classv8_1_1_local_a85570b6ff0a3328627d1b7bc11513a5b}{}\index{v8\+::\+Local@{v8\+::\+Local}!operator==@{operator==}}
\index{operator==@{operator==}!v8\+::\+Local@{v8\+::\+Local}}
\subsubsection[{operator==}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T$>$ template$<$class S $>$ V8\+\_\+\+I\+N\+L\+I\+N\+E bool {\bf v8\+::\+Local}$<$ T $>$\+::operator== (
\begin{DoxyParamCaption}
\item[{const {\bf Local}$<$ S $>$ \&}]{that}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_local_a85570b6ff0a3328627d1b7bc11513a5b}
