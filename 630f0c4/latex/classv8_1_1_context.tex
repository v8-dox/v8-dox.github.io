...
Restores the security token to the default value. \hypertarget{classv8_1_1_context_a6a4ca53837ec39c684cdbfc73ab44e4e}{}\index{v8\+::\+Context@{v8\+::\+Context}!V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+D@{V8\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+E\+D}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_context_a6a4ca53837ec39c684cdbfc73ab44e4e}
Returns true if the context has experienced an out of memory situation. Since \hyperlink{classv8_1_1_v8}{V8} always treats O\+O\+M as fatal error, this can no longer return true. Therefore this is now deprecated. 
