...
Clear interrupt request created by $\vert$\+Request\+Interrupt$\vert$. Can be called from another thread without acquiring a $\vert$\+Locker$\vert$. \hypertarget{classv8_1_1_isolate_a1a5a5762e4221aff8c6b10f9e3cec0af}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Dispose@{Dispose}}
...
Returns the maximum number of available embedder data slots. Valid slots are in the range of 0 -\/ \hyperlink{classv8_1_1_isolate_a7060092fd45588f4085753b3da1b2c82}{Get\+Number\+Of\+Data\+Slots()} -\/ 1. \hypertarget{classv8_1_1_isolate_afb6bbd31a87d0999dbbe5402447690a9}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!In\+Context@{In\+Context}}
...
Returns true if this isolate has a current context. \hypertarget{classv8_1_1_isolate_a36f397e1d09e0122e89641288f348d2d}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!New@{New}}
...
This should only be used for testing purposes and not to enforce a garbage collection schedule. It has strong negative impact on the garbage collection performance. Use Idle\+Notification() or Low\+Memory\+Notification() instead to influence the garbage collection schedule. \hypertarget{classv8_1_1_isolate_a971b6094ecc6c7f55eb6f58a71a8afd3}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Request\+Interrupt@{Request\+Interrupt}}
...
Experimental\+: Runs the Microtask Work Queue until empty \hypertarget{classv8_1_1_isolate_a6c046eb1d5ab19ef11c18c2f6e775df1}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Autorun\+Microtasks@{Set\+Autorun\+Microtasks}}
...
Experimental\+: Controls whether the Microtask Work Queue is automatically run when the script call depth decrements to zero. \hypertarget{classv8_1_1_isolate_a2ae968a7ff8a397f1ac09d32990883f6}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Data@{Set\+Data}}
