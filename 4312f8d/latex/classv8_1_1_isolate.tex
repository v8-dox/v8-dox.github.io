...
\item 
typedef bool($\ast$ \hyperlink{classv8_1_1_isolate_ad4aa92173875832142584ce9486615f8}{abort\+\_\+on\+\_\+uncaught\+\_\+exception\+\_\+t}) ()
\item 
...
\begin{DoxyCompactItemize}
\item 
\hypertarget{classv8_1_1_isolate_a5dab25064f96dd3aedbc46b8cdce2bd2}{}void {\bfseries Set\+Abort\+On\+Uncaught\+Exception} (\hyperlink{classv8_1_1_isolate_ad4aa92173875832142584ce9486615f8}{abort\+\_\+on\+\_\+uncaught\+\_\+exception\+\_\+t} callback)\label{classv8_1_1_isolate_a5dab25064f96dd3aedbc46b8cdce2bd2}
...
\item 
int \hyperlink{classv8_1_1_isolate_a08d71a6a9979e6105d3c730be56e7702}{Context\+Disposed\+Notification} ()
\end{DoxyCompactItemize}
...
\hypertarget{classv8_1_1_isolate_ad4aa92173875832142584ce9486615f8}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!abort\+\_\+on\+\_\+uncaught\+\_\+exception\+\_\+t@{abort\+\_\+on\+\_\+uncaught\+\_\+exception\+\_\+t}}
\index{abort\+\_\+on\+\_\+uncaught\+\_\+exception\+\_\+t@{abort\+\_\+on\+\_\+uncaught\+\_\+exception\+\_\+t}!v8\+::\+Isolate@{v8\+::\+Isolate}}
\subsubsection[{abort\+\_\+on\+\_\+uncaught\+\_\+exception\+\_\+t}]{\setlength{\rightskip}{0pt plus 5cm}typedef bool($\ast$ v8\+::\+Isolate\+::abort\+\_\+on\+\_\+uncaught\+\_\+exception\+\_\+t) ()}\label{classv8_1_1_isolate_ad4aa92173875832142584ce9486615f8}
Custom callback used by embedders to help \hyperlink{classv8_1_1_v8}{V8} determine if it should abort when it throws and no internal handler can catch the exception. If F\+L\+A\+G\+\_\+abort\+\_\+on\+\_\+uncaught\+\_\+exception is true, then \hyperlink{classv8_1_1_v8}{V8} will abort if either\+:
\begin{DoxyItemize}
\item no custom callback is set.
\item the custom callback set returns true. Otherwise it won\textquotesingle{}t abort. 
\end{DoxyItemize}
...
Enables the host application to receive a notification before a garbage collection. Allocations are allowed in the callback function, but the callback is not re-\/entrant\+: if the allocation inside it will trigger the garbage collection, the callback won\textquotesingle{}t be called again. It is possible to specify the G\+C\+Type filter for your callback. But it is not possible to register the same callback function two times with different G\+C\+Type filters. \hypertarget{classv8_1_1_isolate_aaeda5fa60961a3d9d476c46200e30711}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Adjust\+Amount\+Of\+External\+Allocated\+Memory@{Adjust\+Amount\+Of\+External\+Allocated\+Memory}}
...
the adjusted value. 
\end{DoxyReturn}
\hypertarget{classv8_1_1_isolate_a00790d743cec68bbaa8ca7dbf6257f05}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Clear\+Interrupt@{Clear\+Interrupt}}
...
{}
\end{DoxyParamCaption}
)}\label{classv8_1_1_isolate_a00790d743cec68bbaa8ca7dbf6257f05}
Clear interrupt request created by $\vert$\+Request\+Interrupt$\vert$. Can be called from another thread without acquiring a $\vert$\+Locker$\vert$. \hypertarget{classv8_1_1_isolate_a08d71a6a9979e6105d3c730be56e7702}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Context\+Disposed\+Notification@{Context\+Disposed\+Notification}}
...
{}
\end{DoxyParamCaption}
)}\label{classv8_1_1_isolate_a08d71a6a9979e6105d3c730be56e7702}
Optional notification that a context has been disposed. \hyperlink{classv8_1_1_v8}{V8} uses these notifications to guide the G\+C heuristic. Returns the number of context disposals -\/ including this one -\/ since the last time \hyperlink{classv8_1_1_v8}{V8} had a chance to clean up. \hypertarget{classv8_1_1_isolate_a1a5a5762e4221aff8c6b10f9e3cec0af}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Dispose@{Dispose}}
...
Returns the context of the calling Java\+Script code. That is the context of the top-\/most Java\+Script frame. If there are no Java\+Script frames an empty handle is returned. \hypertarget{classv8_1_1_isolate_a7eb415d9210d912aa57877ab6416fec8}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Get\+Cpu\+Profiler@{Get\+Cpu\+Profiler}}
...
Returns true if this isolate has a current context. \hypertarget{classv8_1_1_isolate_aaf446f4877e4707a93d2c406fffd9fd6}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Low\+Memory\+Notification@{Low\+Memory\+Notification}}
...
Optional notification that the system is running low on memory. \hyperlink{classv8_1_1_v8}{V8} uses these notifications to attempt to free memory. \hypertarget{classv8_1_1_isolate_a36f397e1d09e0122e89641288f348d2d}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!New@{New}}
...
When an isolate is no longer used its resources should be freed by calling \hyperlink{classv8_1_1_isolate_a1a5a5762e4221aff8c6b10f9e3cec0af}{Dispose()}. Using the delete operator is not allowed. \hypertarget{classv8_1_1_isolate_a46f0a5d35f8b29030922bdb433c0dc4f}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Remove\+Call\+Completed\+Callback@{Remove\+Call\+Completed\+Callback}}
...
This function removes callback which was installed by Add\+G\+C\+Prologue\+Callback function. \hypertarget{classv8_1_1_isolate_a59fe893ed7e9df52cef2d59b2d98ab23}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Request\+Garbage\+Collection\+For\+Testing@{Request\+Garbage\+Collection\+For\+Testing}}
...
Experimental\+: Runs the Microtask Work Queue until empty Any exceptions thrown by microtask callbacks are swallowed. \hypertarget{classv8_1_1_isolate_a6c046eb1d5ab19ef11c18c2f6e775df1}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Autorun\+Microtasks@{Set\+Autorun\+Microtasks}}
...
Experimental\+: Controls whether the Microtask Work Queue is automatically run when the script call depth decrements to zero. \hypertarget{classv8_1_1_isolate_ab59a904591d417ebb3889b5fa507447b}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Counter\+Function@{Set\+Counter\+Function}}
...
Set the callback to invoke for logging event. \hypertarget{classv8_1_1_isolate_ae4418cb238686a321aa406e90c72fab5}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Set\+Object\+Group\+Id@{Set\+Object\+Group\+Id}}
...
Sets a callback for counting the number of times a feature of \hyperlink{classv8_1_1_v8}{V8} is used. \hypertarget{classv8_1_1_isolate_aba648b3c00dc9f1ef2a22195d99e22e8}{}\index{v8\+::\+Isolate@{v8\+::\+Isolate}!Throw\+Exception@{Throw\+Exception}}
