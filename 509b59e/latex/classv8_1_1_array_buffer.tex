...
\hyperlink{classv8_1_1_data}{Data} length in bytes. \hypertarget{classv8_1_1_array_buffer_a8b90b72486cfacb4fbec157f4803f889}{}\index{v8\+::\+Array\+Buffer@{v8\+::\+Array\+Buffer}!Externalize@{Externalize}}
...
{}
\end{DoxyParamCaption}
)}\label{classv8_1_1_array_buffer_a8b90b72486cfacb4fbec157f4803f889}
...
The memory block is guaranteed to be allocated with $\vert$\+Allocator\+::\+Allocate$\vert$ that has been set with \hyperlink{classv8_1_1_v8_abc40950a39f8cb6946dc8a1ad41eea84}{V8\+::\+Set\+Array\+Buffer\+Allocator}. \hypertarget{classv8_1_1_array_buffer_a50dd263917559439525048c623425c6f}{}\index{v8\+::\+Array\+Buffer@{v8\+::\+Array\+Buffer}!Is\+External@{Is\+External}}
...
{}
\end{DoxyParamCaption}
) const}\label{classv8_1_1_array_buffer_a50dd263917559439525048c623425c6f}
Returns true if \hyperlink{classv8_1_1_array_buffer}{Array\+Buffer} is extrenalized, that is, does not own its memory block. \hypertarget{classv8_1_1_array_buffer_aed177cd83c3368837f740fa2929b3c8d}{}\index{v8\+::\+Array\+Buffer@{v8\+::\+Array\+Buffer}!Is\+Neuterable@{Is\+Neuterable}}
...
{}
\end{DoxyParamCaption}
) const}\label{classv8_1_1_array_buffer_aed177cd83c3368837f740fa2929b3c8d}
Returns true if this \hyperlink{classv8_1_1_array_buffer}{Array\+Buffer} may be neutered. \hypertarget{classv8_1_1_array_buffer_a3420f7d38a8fe20e8f40fb82e6acb325}{}\index{v8\+::\+Array\+Buffer@{v8\+::\+Array\+Buffer}!Neuter@{Neuter}}
...
{}
\end{DoxyParamCaption}
)}\label{classv8_1_1_array_buffer_a3420f7d38a8fe20e8f40fb82e6acb325}
Neuters this \hyperlink{classv8_1_1_array_buffer}{Array\+Buffer} and all its views (typed arrays). Neutering sets the byte length of the buffer and all typed arrays to zero, preventing Java\+Script from ever accessing underlying backing store. \hyperlink{classv8_1_1_array_buffer}{Array\+Buffer} should have been externalized and must be neuterable. \hypertarget{classv8_1_1_array_buffer_ad752e03d7cc7fe863656ad6183785ab7}{}\index{v8\+::\+Array\+Buffer@{v8\+::\+Array\+Buffer}!New@{New}}
...
\item[{size\+\_\+t}]{byte\+\_\+length}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_array_buffer_ad3e0120ae80077d607d5645c4f647932}
Create a new \hyperlink{classv8_1_1_array_buffer}{Array\+Buffer} over an existing memory block. The created array buffer is immediately in externalized state. The memory block will not be reclaimed when a created \hyperlink{classv8_1_1_array_buffer}{Array\+Buffer} is garbage-\/collected. 
