...
\item 
\hypertarget{classv8_1_1_handle_aed50ac02c79d5f22a2717148739e56ab}{}{\footnotesize template$<$class S $>$ }\\V8\+\_\+\+I\+N\+L\+I\+N\+E bool {\bfseries operator==} (const \hyperlink{classv8_1_1_persistent_base}{Persistent\+Base}$<$ S $>$ \&that) const \label{classv8_1_1_handle_aed50ac02c79d5f22a2717148739e56ab}
...
\item 
\hypertarget{classv8_1_1_handle_a67dd4c4ed37d03fb6dc36576f502320e}{}static V8\+\_\+\+I\+N\+L\+I\+N\+E \hyperlink{classv8_1_1_handle}{Handle}$<$ T $>$ {\bfseries New} (\hyperlink{classv8_1_1_isolate}{Isolate} $\ast$isolate, const \hyperlink{classv8_1_1_persistent_base}{Persistent\+Base}$<$ T $>$ \&that)\label{classv8_1_1_handle_a67dd4c4ed37d03fb6dc36576f502320e}
...
\hypertarget{classv8_1_1_handle_a38d25e9394afb08cf0aa088549dad810}{}\index{v8\+::\+Handle@{v8\+::\+Handle}!Handle@{Handle}}
...
)\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_handle_a38d25e9394afb08cf0aa088549dad810}
Creates an empty handle. \hypertarget{classv8_1_1_handle_a9ef27868379876db37322856edeafca7}{}\index{v8\+::\+Handle@{v8\+::\+Handle}!Handle@{Handle}}
\index{Handle@{Handle}!v8\+::\+Handle@{v8\+::\+Handle}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_handle_a9ef27868379876db37322856edeafca7}
Creates a handle for the contents of the specified handle. This constructor allows you to pass handles as arguments by value and to assign between handles. However, if you try to assign between incompatible handles, for instance from a Handle$<$\+String$>$ to a Handle$<$\+Number$>$ it will cause a compile-\/time error. Assigning between compatible handles, for instance assigning a Handle$<$\+String$>$ to a variable declared as \hyperlink{classv8_1_1_handle}{Handle$<$\+Value$>$}, is legal because \hyperlink{classv8_1_1_string}{String} is a subclass of \hyperlink{classv8_1_1_value}{Value}. This check fails when trying to convert between incompatible handles. For example, converting from a Handle$<$\+String$>$ to a Handle$<$\+Number$>$.

\subsection{Member Function Documentation}
\hypertarget{classv8_1_1_handle_a8d20b7afe6afd613b2c026c6bc863d68}{}\index{v8\+::\+Handle@{v8\+::\+Handle}!Clear@{Clear}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_handle_a8d20b7afe6afd613b2c026c6bc863d68}
Sets the handle to be empty. \hyperlink{classv8_1_1_handle_a9e58ac49e3f1a029c2c6e217a61c8419}{Is\+Empty()} will then return true. \hypertarget{classv8_1_1_handle_a9e58ac49e3f1a029c2c6e217a61c8419}{}\index{v8\+::\+Handle@{v8\+::\+Handle}!Is\+Empty@{Is\+Empty}}
...
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_handle_a9e58ac49e3f1a029c2c6e217a61c8419}
Returns true if the handle is empty. \hypertarget{classv8_1_1_handle_a69c7348626e4c4d9788189b4efbac2f0}{}\index{v8\+::\+Handle@{v8\+::\+Handle}!operator"!=@{operator"!=}}
...
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_handle_a69c7348626e4c4d9788189b4efbac2f0}
Checks whether two handles are different. Returns true if only one of the handles is empty, or if the objects to which they refer are different. The handles\textquotesingle{} references are not checked. \hypertarget{classv8_1_1_handle_abdacd07b9678b4545e5dcf6a030ccad5}{}\index{v8\+::\+Handle@{v8\+::\+Handle}!operator==@{operator==}}
\index{operator==@{operator==}!v8\+::\+Handle@{v8\+::\+Handle}}
\subsubsection[{operator==}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T$>$ template$<$class S $>$ V8\+\_\+\+I\+N\+L\+I\+N\+E bool {\bf v8\+::\+Handle}$<$ T $>$\+::operator== (
\begin{DoxyParamCaption}
\item[{const {\bf Handle}$<$ S $>$ \&}]{that}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}\label{classv8_1_1_handle_abdacd07b9678b4545e5dcf6a030ccad5}
