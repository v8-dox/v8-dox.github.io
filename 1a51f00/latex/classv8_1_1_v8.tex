...
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_aee4cfeb1a6153e2e6488fb8e3c1ac6ce}{Remove\+G\+C\+Epilogue\+Callback} (G\+C\+Epilogue\+Callback callback)
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_ad2d640d45bc1a675c5605bb9c5958b29}{Add\+Memory\+Allocation\+Callback} (Memory\+Allocation\+Callback callback, Object\+Space space, Allocation\+Action action)
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_a2e188bdc8a4afccad8e326e2a43e582e}{Remove\+Memory\+Allocation\+Callback} (Memory\+Allocation\+Callback callback)
\item 
...
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_a23fe97e88020bf23ad009f7a4bdb0192}{Terminate\+Execution} (\hyperlink{classv8_1_1_isolate}{Isolate} $\ast$isolate)
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E bool \hyperlink{classv8_1_1_v8_ac9336f620bc684ff6e3c68ee6f549d18}{Is\+Execution\+Terminating} (\hyperlink{classv8_1_1_isolate}{Isolate} $\ast$isolate=N\+U\+L\+L)
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_af73cb6766b9c008d0ba6c6ca991d8328}{Cancel\+Terminate\+Execution} (\hyperlink{classv8_1_1_isolate}{Isolate} $\ast$isolate)
\item 
static bool \hyperlink{classv8_1_1_v8_a566450d632c0a63770682b9da3cae08d}{Dispose} ()
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_a7eb03e6ab4e2eca21632e55a4ad30061}{Visit\+External\+Resources} (\hyperlink{classv8_1_1_external_resource_visitor}{External\+Resource\+Visitor} $\ast$visitor)
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_a824fd99c5cbc7c576370c9ffeca233d4}{Visit\+Handles\+With\+Class\+Ids} (\hyperlink{classv8_1_1_persistent_handle_visitor}{Persistent\+Handle\+Visitor} $\ast$visitor)
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_a79ca881386f5341d0e5d68ebad6addcf}{Visit\+Handles\+With\+Class\+Ids} (\hyperlink{classv8_1_1_isolate}{Isolate} $\ast$isolate, \hyperlink{classv8_1_1_persistent_handle_visitor}{Persistent\+Handle\+Visitor} $\ast$visitor)
\item 
static V8\+\_\+\+I\+N\+L\+I\+N\+E void \hyperlink{classv8_1_1_v8_af5e81135dae7560b5c503050e67c145a}{Visit\+Handles\+For\+Partial\+Dependence} (\hyperlink{classv8_1_1_isolate}{Isolate} $\ast$isolate, \hyperlink{classv8_1_1_persistent_handle_visitor}{Persistent\+Handle\+Visitor} $\ast$visitor)
\item 
...
Enables the host application to receive a notification before a garbage collection. Allocations are not allowed in the callback function, you therefore cannot manipulate objects (set or delete properties for example) since it is possible such operations will result in the allocation of objects. It is possible to specify the G\+C\+Type filter for your callback. But it is not possible to register the same callback function two times with different G\+C\+Type filters. \hypertarget{classv8_1_1_v8_ad2d640d45bc1a675c5605bb9c5958b29}{}\index{v8\+::\+V8@{v8\+::\+V8}!Add\+Memory\+Allocation\+Callback@{Add\+Memory\+Allocation\+Callback}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_ad2d640d45bc1a675c5605bb9c5958b29}
Enables the host application to provide a mechanism to be notified and perform custom logging when \hyperlink{classv8_1_1_v8}{V8} Allocates Executable Memory. \hypertarget{classv8_1_1_v8_a4e8ca19596400bd4df6a345f66daf937}{}\index{v8\+::\+V8@{v8\+::\+V8}!Add\+Message\+Listener@{Add\+Message\+Listener}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a4e8ca19596400bd4df6a345f66daf937}
...
If data is specified, it will be passed to the callback when it is called. Otherwise, the exception object will be passed to the callback instead. \hypertarget{classv8_1_1_v8_af73cb6766b9c008d0ba6c6ca991d8328}{}\index{v8\+::\+V8@{v8\+::\+V8}!Cancel\+Terminate\+Execution@{Cancel\+Terminate\+Execution}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_af73cb6766b9c008d0ba6c6ca991d8328}
Resume execution capability in the given isolate, whose execution was previously forcefully terminated using \hyperlink{classv8_1_1_v8_a23fe97e88020bf23ad009f7a4bdb0192}{Terminate\+Execution()}.

When execution is forcefully terminated using \hyperlink{classv8_1_1_v8_a23fe97e88020bf23ad009f7a4bdb0192}{Terminate\+Execution()}, the isolate can not resume execution until all Java\+Script frames have propagated the uncatchable exception which is generated. This method allows the program embedding the engine to handle the termination event and resume execution capability, even if Java\+Script frames remain on the stack.
...
\hline
\end{DoxyParams}
\hypertarget{classv8_1_1_v8_a7f0bb706c6cd96b8e6dffc813cbc3296}{}\index{v8\+::\+V8@{v8\+::\+V8}!Create\+Snapshot\+Data\+Blob@{Create\+Snapshot\+Data\+Blob}}
...
\begin{DoxyParamCaption}
\item[{char $\ast$}]{custom\+\_\+source = {\ttfamily NULL}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a7f0bb706c6cd96b8e6dffc813cbc3296}
...
Sets the \hyperlink{classv8_1_1_platform}{v8\+::\+Platform} to use. This should be invoked before \hyperlink{classv8_1_1_v8}{V8} is initialized. \hypertarget{classv8_1_1_v8_ae5af79b24fc62e987e08c43ee148424d}{}\index{v8\+::\+V8@{v8\+::\+V8}!Is\+Dead@{Is\+Dead}}
\index{Is\+Dead@{Is\+Dead}!v8\+::\+V8@{v8\+::\+V8}}
\subsubsection[{Is\+Dead}]{\setlength{\rightskip}{0pt plus 5cm}bool v8\+::\+V8\+::\+Is\+Dead (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_ae5af79b24fc62e987e08c43ee148424d}
Check if \hyperlink{classv8_1_1_v8}{V8} is dead and therefore unusable. This is the case after fatal errors such as out-\/of-\/memory situations. \hypertarget{classv8_1_1_v8_ac9336f620bc684ff6e3c68ee6f549d18}{}\index{v8\+::\+V8@{v8\+::\+V8}!Is\+Execution\+Terminating@{Is\+Execution\+Terminating}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_ac9336f620bc684ff6e3c68ee6f549d18}
...
\hline
\end{DoxyParams}
\hypertarget{classv8_1_1_v8_aee4cfeb1a6153e2e6488fb8e3c1ac6ce}{}\index{v8\+::\+V8@{v8\+::\+V8}!Remove\+G\+C\+Epilogue\+Callback@{Remove\+G\+C\+Epilogue\+Callback}}
...
\item[{G\+C\+Epilogue\+Callback}]{callback}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_aee4cfeb1a6153e2e6488fb8e3c1ac6ce}
This function removes callback which was installed by Add\+G\+C\+Epilogue\+Callback function. \hypertarget{classv8_1_1_v8_ae2b102e4db324cf06a92fd9acdd6b112}{}\index{v8\+::\+V8@{v8\+::\+V8}!Remove\+G\+C\+Prologue\+Callback@{Remove\+G\+C\+Prologue\+Callback}}
...
\item[{G\+C\+Prologue\+Callback}]{callback}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_ae2b102e4db324cf06a92fd9acdd6b112}
This function removes callback which was installed by Add\+G\+C\+Prologue\+Callback function. \hypertarget{classv8_1_1_v8_a2e188bdc8a4afccad8e326e2a43e582e}{}\index{v8\+::\+V8@{v8\+::\+V8}!Remove\+Memory\+Allocation\+Callback@{Remove\+Memory\+Allocation\+Callback}}
...
\item[{Memory\+Allocation\+Callback}]{callback}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a2e188bdc8a4afccad8e326e2a43e582e}
Removes callback that was installed by Add\+Memory\+Allocation\+Callback. \hypertarget{classv8_1_1_v8_a103099e00d03c714261e00d75f0d745a}{}\index{v8\+::\+V8@{v8\+::\+V8}!Remove\+Message\+Listeners@{Remove\+Message\+Listeners}}
...
\item[{Message\+Callback}]{that}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a103099e00d03c714261e00d75f0d745a}
Remove all message listeners from the specified callback function. \hypertarget{classv8_1_1_v8_a699f7f6cd694d83ebf3cf28b0137b811}{}\index{v8\+::\+V8@{v8\+::\+V8}!Set\+Allow\+Code\+Generation\+From\+Strings\+Callback@{Set\+Allow\+Code\+Generation\+From\+Strings\+Callback}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a699f7f6cd694d83ebf3cf28b0137b811}
...
Set allocator to use for \hyperlink{classv8_1_1_array_buffer}{Array\+Buffer} memory. The allocator should be set only once. The allocator should be set before any code tha uses Array\+Buffers is executed. This allocator is used in all isolates. \hypertarget{classv8_1_1_v8_a6ed3c6cd32b8d225013445b145381d34}{}\index{v8\+::\+V8@{v8\+::\+V8}!Set\+Capture\+Stack\+Trace\+For\+Uncaught\+Exceptions@{Set\+Capture\+Stack\+Trace\+For\+Uncaught\+Exceptions}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a6ed3c6cd32b8d225013445b145381d34}
...
Allows the host application to provide a callback which can be used as a source of entropy for random number generators. \hypertarget{classv8_1_1_v8_affcb65e1fdf849fadc6302655b981bbc}{}\index{v8\+::\+V8@{v8\+::\+V8}!Set\+Failed\+Access\+Check\+Callback\+Function@{Set\+Failed\+Access\+Check\+Callback\+Function}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_affcb65e1fdf849fadc6302655b981bbc}
Callback function for reporting failed access checks. \hypertarget{classv8_1_1_v8_a290bf883bb4bf8f312089a23a628c067}{}\index{v8\+::\+V8@{v8\+::\+V8}!Set\+Fatal\+Error\+Handler@{Set\+Fatal\+Error\+Handler}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a290bf883bb4bf8f312089a23a628c067}
...
Clears all references to the \hyperlink{classv8_1_1_platform}{v8\+::\+Platform}. This should be invoked after \hyperlink{classv8_1_1_v8}{V8} was disposed. \hypertarget{classv8_1_1_v8_a23fe97e88020bf23ad009f7a4bdb0192}{}\index{v8\+::\+V8@{v8\+::\+V8}!Terminate\+Execution@{Terminate\+Execution}}
...
\item[{{\bf Isolate} $\ast$}]{isolate}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a23fe97e88020bf23ad009f7a4bdb0192}
...
\hline
\end{DoxyParams}
\hypertarget{classv8_1_1_v8_a7eb03e6ab4e2eca21632e55a4ad30061}{}\index{v8\+::\+V8@{v8\+::\+V8}!Visit\+External\+Resources@{Visit\+External\+Resources}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a7eb03e6ab4e2eca21632e55a4ad30061}
Iterates through all external resources referenced from current isolate heap. G\+C is not invoked prior to iterating, therefore there is no guarantee that visited objects are still alive. \hypertarget{classv8_1_1_v8_af5e81135dae7560b5c503050e67c145a}{}\index{v8\+::\+V8@{v8\+::\+V8}!Visit\+Handles\+For\+Partial\+Dependence@{Visit\+Handles\+For\+Partial\+Dependence}}
...
\item[{{\bf Persistent\+Handle\+Visitor} $\ast$}]{visitor}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a824fd99c5cbc7c576370c9ffeca233d4}
Iterates through all the persistent handles in the current isolate\textquotesingle{}s heap that have class\+\_\+ids. \hypertarget{classv8_1_1_v8_a79ca881386f5341d0e5d68ebad6addcf}{}\index{v8\+::\+V8@{v8\+::\+V8}!Visit\+Handles\+With\+Class\+Ids@{Visit\+Handles\+With\+Class\+Ids}}
\index{Visit\+Handles\+With\+Class\+Ids@{Visit\+Handles\+With\+Class\+Ids}!v8\+::\+V8@{v8\+::\+V8}}
\subsubsection[{Visit\+Handles\+With\+Class\+Ids}]{\setlength{\rightskip}{0pt plus 5cm}void v8\+::\+V8\+::\+Visit\+Handles\+With\+Class\+Ids (
\begin{DoxyParamCaption}
\item[{{\bf Isolate} $\ast$}]{isolate, }
\item[{{\bf Persistent\+Handle\+Visitor} $\ast$}]{visitor}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\label{classv8_1_1_v8_a79ca881386f5341d0e5d68ebad6addcf}
